...
from omni_ieeg.channel_model.event_model_inference.dataloader_annotationvalidation import AnnotationValidationDataset
...
class Inferencer():
    ...
    def run_all_inference(self):
        ...
        feature_npzs = glob.glob(f"{self.data_config['feature_path']}/*.npz")
        for feature_npz in feature_npzs:
            print(f"Processing {feature_npz}")
    ...
    def run_one_inference(self, npz_path, save_path):            
        dataset = AnnotationValidationDataset(npz_path)
...
if __name__ == "__main__":
    ...
    output_dir = f"/mnt/SSD1/nipsdataset/channel_training/annotation_check/{model_name}_cross_patient_zurich/{label_name}/"
    ...
    data_config = {
        "feature_path": "/mnt/SSD2/chenda/nipsdataset/annotation_validation_feature_zurich",
