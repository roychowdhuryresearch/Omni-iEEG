...
from omni_ieeg.channel_model.channel_model_train.configs import model_preprocessing_configs
...
class Trainer():
    ...
    def train(self):
        ...
        if continue_train:
            ...
            checkpoint_path = '/mnt/SSD1/nipsdataset/channel_training/channel_train_output/ast/2025-05-14/run1/best_model.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, required=True, choices=["cnn", "vit", "lstm", "transformer", "timesnet", "patchtst", "ast", "seegnet", "clap"], help="Model name (cnn, vit, lstm, transformer, timesnet, patchtst, ast, seegnet, clap)")
