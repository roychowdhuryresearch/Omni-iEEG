...
class ASTClassifier(nn.Module):
    def __init__(self, num_class=5):
        ...
        #     hidden_act="gelu",
        #     hidden_size=128,               # Down from 768
        #     num_hidden_layers=4,           # Down from 12
        #     num_attention_heads=4,         # Keep head_dim = 32 (128 / 4)
        #     intermediate_size=256,         # Feedforward layer size
        #     max_length=1024,                # 14x14 patches for 224x224 input
        #     patch_size=16,                 # Patch size for spectrogram
        #     num_mel_bins=128,              # Frequency axis length (doesn’t matter if inputs_embeds used)
        #     qkv_bias=True,
        #     model_type="audio-spectrogram-transformer",
        #     time_stride=16,                # Can ignore if feeding inputs_embeds directly
        #     frequency_stride=16,
        #     num_labels=num_class,
        # )
