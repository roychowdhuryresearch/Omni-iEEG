...
def process_row(row_data):
    ...
    label = row['label']
    label = 1 if label == "interictal" else 0
...
def extract_labels(final_split, dataset_path, save_path, frequency=1000, n_jobs=8):
    ...
    testing_split = final_split[final_split['split'] == 'test']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="output/features_inference_1min_1000hz", help="Path to save the features")
